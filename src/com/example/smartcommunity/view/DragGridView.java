...
public class DragGridView extends GridView {
	...
	protected float mLastMotionRemainder;
	...
	protected final static int TOUCH_STATE_NEXT_PAGE = 4;
	...
	protected Runnable mDelayedSnapRunnable;
	...
	private Runnable mLongClickRunnable = new Runnable() {
		...
		public void run() {
			...
			// 根据我们按下的点显示item镜像
			createDragImage(mDragBitmap, (int) mDownMotionX, (int) mDownMotionY);
		}
	};
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if (adapter instanceof DragGridAdapterBase) {
			...
			throw new IllegalStateException(
					"the adapter must be implements DragGridAdapterBase");
		}
	}
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mDragPosition = pointToPosition((int) mDownMotionX,
					(int) mDownMotionY);
			...
			mPoint2ItemTop = (int) (mDownMotionY - mStartDragItemView.getTop());
			mPoint2ItemLeft = (int) (mDownMotionX - mStartDragItemView
					.getLeft());

			mOffset2Top = (int) (ev.getRawY() - mDownMotionY);
			mOffset2Left = (int) (ev.getRawX() - mDownMotionX);
	...
	protected void snapToPage(int whichPage, int delta, int duration,
			...
			if (focusedChild != null && whichPage != mCurrent && focusedChild == getPageAt(mCurrent)) {
				
			}
	}

	protected void snapToPage(int whichPage, Runnable r){
		if (mDelayedSnapRunnable != null) {
			mDelayedSnapRunnable.run();
		}
		mDelayedSnapRunnable = r;
